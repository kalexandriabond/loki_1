...
instruction1 = (
    "Now you are going to match greebles at different categories. After the fixation point, you will be "
    "presented a sample greeble and four more greebles following it. A category will be given at the "
    "beginning each trial. The categories are 'family' or 'sex'. If the following "
    "greebles match the category of the first one, press the left (yellow) button with your left thumb; "
    "if not, press the right (red) button with your right thumb. "
    + small_vertical_txt_break
...
matchTime_clock = core.Clock()  # TODO
rt_clock = core.Clock()
...
events_header = "stim_onset, stim_duration, trial_num, trial_type, rt, choice"
